...
RESULTS_DIR = '/data/steeve/mask_rcnn/results/'
...
class SubtitleDataset(utils.Dataset):
    ...
    def load_subtitle(self, dataset_dir, subset):
...
#             print(os.path.join(dataset_dir, "images/{}.png".format(image_id)))
            self.add_image(
                "subtitle",
                image_id=image_id,
...
def detect(model, dataset_dir, subset):
    ...
    submit_dir = "Prediction_{:%Y%m%dT%H%M%S}".format(datetime.datetime.now())
    submit_dir = os.path.join(RESULTS_DIR, submit_dir)
    os.makedirs(submit_dir)

    # Read dataset
    dataset = SubtitleDataset()
    dataset.load_subtitle(dataset_dir, subset)
    dataset.prepare()
    # Load over images
